...
public class SystemInfoUtil {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SystemInfoUtil.class);
...
//    private static OperatingSystem operatingSystem = systemInfo.getOperatingSystem();
    ...
    public Map getCpuInfo() {
        ...
        CentralProcessor processor = getSystemInfo().getHardware().getProcessor();
        // CPU信息
    ...
    public Map getMemInfo() {
        ...
        GlobalMemory memory = getSystemInfo().getHardware().getMemory();
        //总内存
     ...
     * 系统盘符信息
     */
    public List<Map> getSysFileInfo() {
        List<Map> sysFiles = new ArrayList<Map>();
        FileSystem fileSystem = getSystemInfo().getOperatingSystem().getFileSystem();
