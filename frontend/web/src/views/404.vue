<template>
  <div class="body">
    <div class="error"> <span>Page not found</span><span>404</span><span>Swim Home, Friend</span>
      <el-button type="primary" style="margin-top:10px" @click="backHome">Back Home</el-button>
    </div>
    <div class="sun"></div>
    <div class="clouds">
      <div></div>
...
<style scoped>
@import url("https://fonts.loli.net/css?family=Libre+Franklin");
.body {
  position: fixed;
  height: 100%;
  width: 100%;
